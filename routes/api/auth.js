...
const {login, logout, signup, verify, repeatVerify, getCurrent, subscriptionStatusUpdate, avatarUpdate} = require("../../controllers/auth.controller");
const {validation, auth, upload} = require('../../middleware');
const { userAuthSchema, subscriptionStatusSchema, userRepeatVerificationSchema } = require("../../validationSchemas");
...
router.post("/verify", validation(userRepeatVerificationSchema), tryCatchWrapper(repeatVerify));
